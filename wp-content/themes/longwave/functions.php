...
//update themeoptions
$check_blog_options = get_option('tb_longwave_theme_blog_options');
if(empty($check_blog_options)) update_option('tb_longwave_theme_blog_options',array("tb_longwave_blog_single_default_sidebar" => "nosidebar", "tb_longwave_blog_archive_style" => "left", "tb_longwave_blog_archive_sidebar" => "nosidebar", "tb_longwave_blog_category_style" => "left", "tb_longwave_blog_category_sidebar" => "nosidebar"));
