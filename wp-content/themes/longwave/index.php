...
<?php
	...
	//Default Values
		...
		//Excerpt Length
		$pageoptions["tb_longwave_page_blog_excerpt"] = empty($pageoptions["tb_longwave_page_blog_excerpt"]) ? 55 : $pageoptions["tb_longwave_page_blog_excerpt"];
		...
		function new_excerpt_length($length) {
			global $pageoptions;
		    return $pageoptions["tb_longwave_page_blog_excerpt"];
		}
  ...
  <?php if($headline){
  			 if(empty($pageoptions["tb_longwave_page_intro"])){ ?>	
					...
					<div class="dark-wrapper page-title"> 
						<!-- Begin Inne -->
						<div class="inner">
							<h1 class="title alignleft"><?php echo get_the_title($post_id); ?>
							...
							<?php head_pagination($paged,$posts_per_page); ?>
							<div class="clear"></div>
						</div>
						<!-- End Inner --> 
					</div>
