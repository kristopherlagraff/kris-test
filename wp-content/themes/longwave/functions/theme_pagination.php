	...
	{			
		...
		{				
			...
			//Next/Prev Links
				if($current<$total){
					echo '<li>
					<a href="'.get_pagenum_link($current+1).'">'.__("next","tb_longwave").'</a>
					</li>
					';
					echo '<li>
					<a href="'.get_pagenum_link($total).'">'.__("last","tb_longwave").'</a>
					</li>
					';
				}
				else{
					echo '<li>
					<a href="'.get_pagenum_link(1).'">'.__("first","tb_longwave").'</a>
					</li>
					';
					echo '<li>
					<a href="#" class="current">'.__("last","tb_longwave").'</a>
					</li>
					';
				}
			// The End
