...
$custom_post_portfolio_type_meta_fields = array(
		...
		array(
			'label'	=> '',
			'id' 	=> '',
			'desc'	=> 'The "<strong>featured image</strong>" you set below will be used to display thumb preview pics and optional lightbox pics (and as head image if you choose the post type above)',
			'type'	=> 'desc',
			'class' => ''
		)
);
